    ...
    <div class="container" id="decorate">
      <br><br>
        ...
        <div class="col-lg-12 well well-sm" style="padding-bottom: 50px;">
          <form class="form form-vertical" action="include/addStaff.php" method="POST">
             <br><br>
             <div class="row">
                   ...
                   <div class="row">
                     ...
                     <div class="col-sm-4">
                       <div class="form-group">
                         ...
                         <select class="form-control" data-style="btn-primary" id="dept" name="dept" style="height: calc(2.25rem + 10px);">
